...
namespace RoutingConsts
{
    ...
    static const std::string create_microblog = "/create/microblog/:name/author/:id/private/:p";
...
namespace QueriesConsts
{
    ...
    static const std::string create_microblog = "create microblog";
    static const std::string create_microblog_query = "INSERT INTO microblog (name, author, private) VALUES($1, $2, $3) RETURNING id_microblog";
}